...
StoryForge 是一个面向长篇小说创作的 AI Agent 工程。当前实现到 Milestone 9：在规划、生成、评估、修订、长期记忆与 API/CLI 能力上，增加可部署的 Web 控制中心，用于项目管理、工作流审计、版本比较、冲突处理和检索调试。
...
[ROADMAP.md](ROADMAP.md) 是交付顺序的唯一依据。Milestone 9 已实现；本次没有开始 Milestone 10。
